...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/jpeg", "image/png", "image/jpg", "application/pdf"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for prescription-images" ON storage.objects FOR SELECT USING (bucket_id = 'prescription-images');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for prescription-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'prescription-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for prescription-images" ON storage.objects FOR UPDATE USING (bucket_id = 'prescription-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for prescription-images" ON storage.objects FOR DELETE USING (bucket_id = 'prescription-images');`
    ];
