...
COMMENT ON TABLE user_behavior_profiles IS 'User behavior patterns for anomaly detection';
...
COMMENT ON TABLE data_access_log IS 'Healthcare-specific data access audit trail';
